...
const Friend = ({ friend, activeChatUser }) => {
    ...
    return (
        <li className={`list-group-item list-group-item-action ${activeChatUser && "active"} d-flex align-items-center justify-content-between overflow-auto`} onClick={() => dispatch({ type: "SELECT_CHAT", payload: friend })}>
            {
                frnd._id ? (
                    <>
